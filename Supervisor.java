...
public class Supervisor extends User{
	...
	private static JComboBox<String> staffm,request;
	private static JTextArea area,area2;
	private static JTable table,table2,table3,table4,table5;
	private static JScrollPane scrollPane2,scrollPane,sp,sp2,sp3,sp4,sp5;
	private static JFrame frame4,frame6,frame7,frame8,frame9;
	private static JPanel fpane2,pane1,pane2,fpane3,fpane4,fpane5;
	private static JButton leaveapply,log2gm,ok4,viewbtn3,createtask,ok3,viewrep,aclgbtn,rjlgbtn,aclvbtn,rjlvbtn,acusrbtn,rjusrbtn,viewbtn,viewbtn2,deletebtn ,btn1,btn2,btn3,btn4,btn5,btn6,btn7,ok2,ok,cancel,repsbtn,reqsbtn,taskbtn,loutbtn,logsbtn,staffbtn;
	private static JLabel lv1,lv2,lv3,lv4,lv5,task1,task2,task3,task4,fms,logo,date,welcome,l1,l2,l3,l4,l5,l6,disphome,loggeduser;
	...
	public static void createGUI()
	{
	    ...
	    log2gm=new JButton("Forward to GM");
		...
		for (int i = 0; i <= 10; i++) {
			...
			model.setValueAt("AV User"+ (i+1), i, 1);
		}
		for (int i = 0; i <= 10; i++) {
			model2.addRow(new Object[0]);
			model2.setValueAt(false, i, 0);
			model2.setValueAt("AV User req"+ (i+1), i, 1);
			}
		for (int i = 0; i <= 10; i++) {
			model3.addRow(new Object[0]);
			model3.setValueAt(false, i, 0);
			model3.setValueAt("AV Leave req"+ (i+1), i, 1);
			model3.setValueAt("AV Leave req"+ (i+1), i, 2);
			model3.setValueAt("AV Leave req"+ (i+1), i, 3);
			}
		
	for (int i = 0; i <= 10; i++) {
		model4.addRow(new Object[0]);
		model4.setValueAt(false, i, 0);
		model4.setValueAt("AV Logistic"+ (i+1), i, 1);
		model4.setValueAt("AV Logistic"+ (i+1), i, 2);
		model4.setValueAt("AV Logistic"+ (i+1), i, 3);
		model4.setValueAt("AV Logistic"+ (i+1), i, 4);
		}
	
	for (int i = 0; i <= 10; i++) {
		model5.addRow(new Object[0]);
		model5.setValueAt(false, i, 0);
		model5.setValueAt("AV Task"+ (i+1), i, 1);
		model5.setValueAt("AV Task"+ (i+1), i, 2);
		model5.setValueAt("AV Task"+ (i+1), i, 3);
		}
