					...
					public void actionPerformed(ActionEvent arg0) {
						...
						depts.setBorder(original);
						 String b=usname.getText();
					        ...
					        String l=dobs.getText();
					        String h=addr.getText();
					        String z = (String)depts.getSelectedItem();
					        
					        Boolean v=check_info( b, c, d, e, f, l, h, z, m1);
						...
						if(!(usname.getText().equals("")) && !(pswd.getPassword().length<6) && !(names.getText().equals("")) && (dobs.getText().length()==6) && !(addr.getText().equals("")) && !(depts.getSelectedIndex()==0) && !(deptypes.getSelectedIndex()==0) && v)
						{
							frame2.setVisible(false);
							generate_id();
							JOptionPane.showMessageDialog(frame2,
							    "Your unique user id is "+(idcount-1),
							    "USER ID GENERATOR",
